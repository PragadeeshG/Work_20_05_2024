...
public class ActiveBatchJobMaintenance {
	...
	public ActiveBatchJobMaintenance() {

	}

	public ActiveBatchJobMaintenance(Integer batchJobId, String downTimeApplicable, String downTimeNotificationMode,
			String fromSystem, String toSystem, String activeDirectory, String openId, boolean serverless,
			String serveerlessModelName, String lambdas, String queueName, String queueType, String status) {
		super();
